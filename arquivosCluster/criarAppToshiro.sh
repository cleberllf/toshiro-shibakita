...
#sudo docker build -t proxy-reverso:1.0 proxyReverso/.
sudo docker stack up toshiro -c toshiro-stack.yml
#sudo cp app/*.* /var/lib/docker/volumes/toshiro_dados-app/_data/
#sleep 60
#mysql -u root --protocol=tcp -D bd_toshiro -pSenha123 < banco.sql
